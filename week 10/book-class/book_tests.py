...
class CrashTest(unittest.TestCase):
    ...
    def test_init(self):
        """
        This test is to check if the constructor works correct
        """
    ...
    def test_get_title(self):
        """
        This test is to check if get_title() works correct
        """        
    ...
    def test_get_author(self):
        """
        This test is to check if get_author() works correct
        """ 
    ...
    def test_get_year(self):
        """
        This test is to check if get_year() works correct
        """ 
        book = Book("9780394800011", "Widely UU", "IvyAtemis", 1999,
                    "PDF", "college.txt")
    ...
    def test_get_format(self):
        """
        This test is to check if get_format() works correct
        """ 
        book = Book("9780394800011", "Widely UU", "IvyAtemis", 1999,
                    "PDF", "college.txt")
    ...
    def test_get_readability_grade(self):
        """
        This test is to check if get_readability_grade() works correct
        """ 
    ...
    def test_get_index(self):
        """
        This test is to check if get_index() works correct
        """ 
